...
**Service-unknown dynamic discovery** — when the symptom is global ("everything is slow", "errors across the board"), use grouped Tempo metrics as the first discovery pass before Prometheus fallback.
